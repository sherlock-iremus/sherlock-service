...
import fr.cnrs.iremus.sherlock.pojo.resource.E13LinkedResource;
...
@Controller("/api/e13_linked_resource")
@Secured(SecurityRule.IS_AUTHENTICATED)
public class E13LinkedResourceController {
    ...
    public String createLinkedResource(@Valid @Body E13LinkedResource body, Authentication authentication) throws ParseException {
        ...
        try (RDFConnectionFuseki conn = (RDFConnectionFuseki) builder.build()) {
            ...
            String a = sherlock.modelToJson(res);
            return a;
        }
    }
}
